...
{
    [Activity(Label = "@string/title_notifications", ParentActivity = typeof(MainActivity), Theme = "@style/AppTheme")]
    public class ContactActivity : AppCompatActivity, BottomNavigationView.IOnNavigationItemSelectedListener
    {
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            ...
            navigation.SelectedItemId = Resource.Id.navigation_notifications;
