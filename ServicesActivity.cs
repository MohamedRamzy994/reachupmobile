...
{
    [Activity(Label = "@string/title_dashboard", ParentActivity = typeof(MainActivity), Theme = "@style/AppTheme")]
    public class ServicesActivity : AppCompatActivity, BottomNavigationView.IOnNavigationItemSelectedListener
    {
